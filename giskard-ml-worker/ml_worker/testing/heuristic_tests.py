...
class HeuristicTests(AbstractTestCollection):
    def test_right_label(self,
        ...
        prediction_results = run_predict(slice_df.df, model).prediction
        ...
        passed_slice = slice_df.df.loc[prediction_results == classification_label]
    ...
    def test_output_in_range(self,
        ...
        prediction_results = run_predict(slice_df.df, model)
        ...
        expected = slice_df.df[matching_prediction_mask]
