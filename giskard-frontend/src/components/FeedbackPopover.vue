  ...
  <v-menu offset-x :close-on-content-click="false" v-model="opened">
    ...
    <v-card dark color="primary">
      <v-card-title>
        ...
        <div v-else-if="originalValue === inputValue">Does the impact of
      ...
      <v-card-actions>
        ...
        <v-btn small color="white" light @click="submitFeedback"
               :disabled="(!(selected && message) && feedbackType!==FeedbackType.TARGET)">Send
        </v-btn>
