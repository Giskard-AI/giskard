...
{% hint style="success" %}
**Cloud installation:** To install Giskard in the **Cloud**, please go to the [**AWS**](docs/guide/instal_aws/index.md), [**GCP**](docs/guide/instal_gcp/index.md), and [**Azure**](docs/guide/instal_azure/index.md) installation pages&#x20;
{% endhint %}
