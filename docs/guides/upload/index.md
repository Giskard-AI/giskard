# ⬆️ Log datasets & models in the Giskard hub

You can easily upload to the Giskard hub objects, such as **model**, **dataset**, **slicing & transformation functions** and **test suite**.
...
To install the Giskard hub, please check the [run the Giskard hub](../installation_app/index.rst) page.
