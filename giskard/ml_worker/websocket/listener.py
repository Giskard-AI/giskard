...
from giskard.core.suite import Suite, _generate_test_partial
...
def run_test_suite(
    ...
    try:
        ...
        for t, (identifier, result, _) in zip(tests, suite_result.results):
            arguments = Suite.create_test_params(_generate_test_partial(t["test"], t["arguments"]), global_arguments)
