...
# TODO: make this generic (Chromadb, ...)
...
class LangchainRetrievalQAModel(MLFlowSerializableModel):
    ...
    def to_mlflow(self, artifact_path: str = "langchain-model-from-giskard", **kwargs):
        return mlflow.langchain.log_model(self.model, artifact_path, loader_fn=load_retriever,
