...
def test_right_label(
    ...
    """Test if the model returns the right classification label for a slice

    The test is passed when the percentage of rows returning the right
    ...
    threshold : float
        Threshold for the percentage of passed rows (Default value = 0.5)
    debug : bool
        If True and the test fails,
        a dataset will be provided containing the rows that do not return the right classification label. (Default value = False)
...
def test_output_in_range(
    ...
    """Test if the model output belongs to the right range for a slice

    The test is passed when the ratio of rows in the right range inside the
    ...
    classification_label : Optional[str]
        Optional. Classification label you want to test (Default value = None)
    min_range : float
        Minimum probability of occurrence of classification label (Default value = 0.3)
    max_range : float
        Maximum probability of occurrence of classification label (Default value = 0.7)
    threshold : float
        Threshold for the percentage of passed rows (Default value = 0.5)
    debug : bool
        If True and the test fails,
        a dataset will be provided containing the rows that are out of the given range. (Default value = False)
...
def test_nominal_association(
    ...
    """Tests for nominal association between a dataset slice and the model predictions.

    A statistical test for nominal association between the dataset slice and the model predictions. It aims to
    ...
    method : Optional[str]
        ...
        (default = "theil_u")
    threshold : float
        Threshold value for the Cramer's V score (Default value = 0.5)
    debug : bool
        If True and the test fails,
        a dataset will be provided containing the rows of the dataset slice. (Default value = False)
...
def test_mutual_information(
    ...
    slicing_function : SlicingFunction
        Slicing function to be applied on the dataset
    threshold : float
        Threshold value for the mutual information score (Default value = 0.5)
    debug : bool
        If True and the test fails,
        a dataset will be provided containing the rows of the dataset slice. (Default value = False)
...
def test_theil_u(
    ...
    slicing_function : SlicingFunction
        Slicing function to be applied on the dataset
    threshold : float
        Threshold value for the Theil's U score (Default value = 0.5)
    debug : bool
        If True and the test fails,
        a dataset will be provided containing the rows of the dataset slice. (Default value = False)
